...
bool Hotkeys::Start(const Config& cfg, Action onToggle,
    ...
    // Ctrl+Shift+<letter> chord bindings (Y/G/H cluster); ChordGuarded
    ...
    Log::Line("Hotkeys: toggle=0x%02X cyclemode=0x%02X yawmode=0x%02X chords=%d/%d/%d",
              cfg.vk_toggle, cfg.vk_position, cfg.vk_yaw_mode,
